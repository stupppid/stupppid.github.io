...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pages/pingpong/assets/pingpong.gltf":[function(require,module,exports) {
module.exports = "/pingpong.fbb2712d.gltf";
},{}],"pages/pingpong/assets/racket.gltf":[function(require,module,exports) {
module.exports = "/racket.bbbda362.gltf";
...
},{"./bundle-url":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/three/examples/js/controls/OrbitControls.js":[function(require,module,exports) {
/**
...
},{}],"node_modules/three/examples/js/loaders/GLTFLoader.js":[function(require,module,exports) {
/**
...
},{}],"pages/pingpong/index.js":[function(require,module,exports) {
var THREE;
var Ammo;
var scene;
var camera;
...
function initPhysics() {
  ...
  var dispather = new Ammo.btCollisionDispatcher(config);
...
function updatePhysics(deltaTime) {
  ...
  dynamicsWorld.stepSimulation(deltaTime, 10); // updateAction();
  // Update rigid bodies
...
function addRigidBody(_ref) {
  var shape = _ref.shape,
      _ref$mass = _ref.mass,
      mass = _ref$mass === void 0 ? 0 : _ref$mass,
      _ref$localInertia = _ref.localInertia,
      localInertia = _ref$localInertia === void 0 ? new Ammo.btVector3(0, 0, 0) : _ref$localInertia,
      bodyInfo = _ref.bodyInfo,
      pos = _ref.pos,
      quat = _ref.quat;
  ...
  var ms = new Ammo.btDefaultMotionState(t);
  shape.calculateLocalInertia(mass, localInertia);
  var rbInfo = new Ammo.btRigidBodyConstructionInfo(mass, ms, shape, localInertia);
...
function createHouse(length, width, height) {
  var h = 0.1;
  var ground = new THREE.Mesh(new THREE.BoxGeometry(length, height, width), new THREE.MeshPhongMaterial({
    color: 0x646568,
...
function createObjects() {
  ...
  var pLight = new THREE.PointLight(0x808080, 1, 3000, 0.9);
  ...
  var radius = 2;
  var ball = new THREE.Mesh(new THREE.SphereGeometry(radius, 10, 10), new THREE.MeshLambertMaterial({
    color: 0xffaa00
  }));
  ...
  scene.add(ball);
  var ballShape = new Ammo.btSphereShape(radius);
  ball.addRigidBody({
    shape: ballShape,
    mass: 0.26,
...
function initWorld() {
  ...
  window.addEventListener('keydown', function (e) {
    ...
    var bd = racket.userData.physicsBody;
    var origin = bd.getWorldTransform().getOrigin();
...
function index() {
  ...
  function init() {
    if (flagArr.every(function (value) {
      return value;
    })) {
      initPhysics();
      initWorld();
...
},{"./assets/pingpong.gltf":"pages/pingpong/assets/pingpong.gltf","./assets/racket.gltf":"pages/pingpong/assets/racket.gltf","_bundle_loader":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-loader.js","ammo.js":[["ammo.d2e34519.js","node_modules/ammo.js/ammo.js"],"ammo.d2e34519.js.map","node_modules/ammo.js/ammo.js"],"three":[["three.module.8953a33b.js","node_modules/three/build/three.module.js"],"three.module.8953a33b.js.map","node_modules/three/build/three.module.js"],"three/examples/js/controls/OrbitControls":"node_modules/three/examples/js/controls/OrbitControls.js","three/examples/js/loaders/GLTFLoader":"node_modules/three/examples/js/loaders/GLTFLoader.js"}],"../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js",0,"pages/pingpong/index.js"], null)
//# sourceMappingURL=/pingpong.e7a0c4bf.js.map